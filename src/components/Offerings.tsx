      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {offerings.map((offering, index) => (
            <div
              ...
              className="group bg-gray-50 rounded-2xl p-8 text-center hover:shadow-xl transition-all duration-300 cursor-pointer transform hover:-translate-y-2"
            >
              ...
              <div className="flex items-center justify-center text-green-600 font-medium group-hover:text-green-700 transition-colors">
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-green-600 to-green-700 text-white rounded-2xl p-8 max-w-4xl mx-auto">
            ...
            <button
              onClick={() => onNavigate('services')}
              className="bg-white text-green-600 px-8 py-3 rounded-lg font-medium hover:bg-green-50 transition-colors inline-flex items-center space-x-2"
            >
